        ...
        <AppShell>
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">➕ Tambah Data Siswa</h1>
                        <p className="text-gray-600">Masukkan data siswa baru</p>
                    </div>
                </div>
                ...
                <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-4">
                        ...
                        <ul className="text-sm text-blue-800 space-y-1">
                            <li>• NISN harus unik dan terdiri dari 10 digit angka</li>
                            <li>• Nilai akhir dalam rentang 0-100 dengan 2 desimal</li>
                            <li>• Status kelulusan akan menentukan pengumuman yang ditampilkan</li>
                            <li>• Catatan bersifat opsional dan dapat digunakan untuk informasi tambahan</li>
                        </ul>
                    </CardContent>
                </Card>
            </div>
